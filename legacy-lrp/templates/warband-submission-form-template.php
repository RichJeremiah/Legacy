<?php
/* Template Name: Warband Submission Form
* Created by PhpStorm.
* User: Richard
* Date: 17/12/2017
* Time: 21:35
    ...
    <div id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
            ...
            <?php while (have_posts()) :
                ...
                //START OF FORM TEMPLATE
                //output of successful post
                if (isset($_REQUEST['warband_add_notice'])) : ?>
                <?php if ($_REQUEST['warband_add_notice'] === "success") : ?>
                    ...
                    <form method="POST" action="" id="warband-form" class="" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <small id="warbandSmDescHelpBlock" class="form-text text-muted">
                                Please provide a short description for your warband which can be used as part of the
                                public
                            ...
                            <div class="card card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <small id="warbandDeitySmDescHelpBlock" class="form-text text-muted">
                                        Please provide a short description for your deity which can be used as part of
                                        the
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" id="warband-isOpen"
                                       name="warband-isOpen"> Check this box to make this Warband available for anyone
                                to
                                join.
                            </label>
                        </div>
