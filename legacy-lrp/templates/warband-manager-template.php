        ...
        <div id="main" class="site-main" role="main">
            ...
            <div>
                ...
                <?php if (!$warband_manager->is_warband_owner() && !$warband_manager->is_warband_member()) : ?>
                    <div>You are not a member of any Warbands - please consider joining a warband as they can provide a
                        lot
                    ...
                    <div id="main-container">
                        ...
                        <div id="container">
                            <ul class="nav nav-tabs nav-fix" id="wbTabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="warband-tab" data-toggle="tab" href="#warband"
                                       role="tab"
                            ...
                            <div class="tab-content" id="wbTabContent">
                                <div class="tab-pane fade show active" id="warband" role="tabpanel"
                                     aria-labelledby="warband-tab">
