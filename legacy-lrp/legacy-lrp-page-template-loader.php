...
class Legacy_LRP_Page_Template_Loader {
     ...
     * @var      string
     */
    protected $plugin_slug = 'legacy-lrp';
	 ...
	 * @since 0.1.0
	 *
	 * @var   Legacy_LRP_Page_Template_Loader
	 */
	...
	public static function get_instance() {
		...
		if( null == self::$instance ) {
			self::$instance = new Legacy_LRP_Page_Template_Loader();
		} // end if
